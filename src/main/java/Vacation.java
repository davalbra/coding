...
public class Vacation {
	...
	/**
	 * Crea un objeto Vacation con el destino, duración y cantidad de viajeros
	 * especificados.
	 *
	 ...
	 *
	 * @return el costo total de las vacaciones, o -1 si el número de viajeros es
	 *         mayor o igual a 80.
	 */
	public double calcularCostoVacaciones() {
		if (cantidadViajeros < 80) {
			...
			double totalOdd = calculateOdd(totalConDuracion, odd);
			return totalOdd;
		} else {
			return -1;
		}
	...
	private double calculateOdd(double costoBase, double odd) {
		if (odd == 1) {
			return costoBase + 200;
		} else if (odd == 2) {
